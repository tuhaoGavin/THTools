...
@interface THSettingsTimeRangePickerView : UIPickerView<UIPickerViewDelegate, UIPickerViewDataSource>
...
@implementation THSettingsTimeRangePickerView
{
...
@interface THSettingsTimeRangView ()
{
...
@property (nonatomic, strong) THSettingsTimeRangePickerView *leftPicker;//左选择器
@property (nonatomic, strong) UILabel            *centerLabel;//中心点文本
@property (nonatomic, strong) THSettingsTimeRangePickerView *rightPicker;//右选择器
...
@implementation THSettingsTimeRangView
...
- (void)sureBtnAction:(UIButton *)sender {
    if (_sureBtnBlock) {
        ...
        [THViewController(self) dismissViewControllerAnimated:YES completion:nil];
    }
    [self hideInWindow];
}
...
- (THSettingsTimeRangePickerView *)leftPicker {
    if (!_leftPicker) {
        _leftPicker = [[THSettingsTimeRangePickerView alloc] initWithFrame:CGRectZero data:data];
    }
    return _leftPicker;
}
- (UILabel *)centerLabel {
...
- (THSettingsTimeRangePickerView *)rightPicker {
    if (!_rightPicker) {
        _rightPicker = [[THSettingsTimeRangePickerView alloc] initWithFrame:CGRectZero data:data];
    }
    return _rightPicker;
}
- (UIButton *)cancelBtn {
