...
@implementation UIImage (Capture_th)
 ...
 *  @return 图片
 */
+ (UIImage *)th_captureWithView:(UIView *)view
{
...
+ (UIImage *)th_getImageWithSize:(CGRect)myImageRect FromImage:(UIImage *)bigImage
{
    //大图bigImage
    //定义myImageRect，截图的区域
 ...
 *  @return 截图
 */
+ (UIImage *)th_screenshotWithView:(UIView *)aView limitWidth:(CGFloat)maxWidth{
 ...
 *  @return 返回修改后的新图片
 */
+ (UIImage *)th_scaleToSize:(UIImage *)img size:(CGSize)newsize{
    // 创建一个bitmap的context
