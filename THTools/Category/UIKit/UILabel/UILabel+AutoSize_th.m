...
@implementation UILabel (AutoSize_th)

-(UILabel *)th_resizeLabelHorizontal{
    return [self th_resizeLabelHorizontal:0];
}

- (UILabel *)th_resizeLabelVertical{
    return [self th_resizeLabelVertical:0];
}

- (UILabel *)th_resizeLabelVertical:(CGFloat)minimumHeigh{
...
- (UILabel *)th_resizeLabelHorizontal:(CGFloat)minimumWidth{
    CGRect newFrame = self.frame;
