...
- (void)rectCornerWithTopLeft:(CGFloat)topLeft topRight:(CGFloat)topRight bottomLeft:(CGFloat)bottomLeft bottomRight:(CGFloat)bottomRight {
    ...
    YQCornerRadii corner = YQCornerRadiiMake(topLeft, topRight, bottomLeft, bottomRight);
...
#pragma mark - Private
YQCornerRadii YQCornerRadiiMake(CGFloat topLeft,CGFloat topRight,CGFloat bottomLeft,CGFloat bottomRight) {
    return (YQCornerRadii){
        topLeft,
        topRight,
        bottomLeft,
        bottomRight,
