...
@implementation NSString (URLEncode_th)
...
- (NSString *)th_urlEncode {
    return [self th_urlEncodeUsingEncoding:NSUTF8StringEncoding];
}
/**
 *  @brief  urlEncode
 *
...
- (NSString *)th_urlDecode {
    return [self th_urlDecodeUsingEncoding:NSUTF8StringEncoding];
}
/**
 *  @brief  urlDecode
 *
