...
+ (NSMutableAttributedString *)yq_changeWithTargetString:(NSString *)targetStr rangStrings:(NSArray *)rangStrings colers:(NSArray *)colors fonts:(NSArray *)fonts
{
...
+ (NSMutableAttributedString *)yq_getAttributedStringWithString:(NSString *)string lineSpace:(CGFloat)lineSpace {
...
+ (NSString *)yq_getAgeWithBirth:(NSString *)birth {
...
+ (NSString *)yq_noEmptyStr:(NSString *)str {
    if ([self yq_isEmptyString:str]) {
        return @"";
    } else {
        return str;
    }
...
//传入 秒  得到 xx:xx:xx
+(NSString *)yq_getHHMMSSFromSS:(NSString *)totalTime{
...
//传入 秒  得到  xx分钟xx秒
+(NSString *)yq_getMMSSFromSS:(NSString *)totalTime{
...
- (NSString *)yq_noEmptyStr {
    return [NSString yq_noEmptyStr:self];
}
@end
