#
#  Be sure to run `pod spec lint THTools.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/tuhaoGavin/THTools"
  ...
  spec.author             = { "涂浩" => "474655014@qq.com" }
  # Or just: spec.author    = "涂浩"
  # spec.authors            = { "涂浩" => "474655014@qq.com" }
  # spec.social_media_url   = "https://twitter.com/涂浩"
  ...
  spec.source       = { :git => "https://github.com/tuhaoGavin/THTools.git", :tag => spec.version }
